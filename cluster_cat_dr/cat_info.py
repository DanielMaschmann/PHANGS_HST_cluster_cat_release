...
class CatalogInfo(PhangsObsInfo, PhysParams):
    ...
    def __init__(self):
        ...
        self.cat_info = {
            ...
            'FlagOGC_veryred' : {'col_name': 'FlagOGC_veryred', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGCpoly_veryred' : {'col_name': 'OGCpoly_veryred', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGC_Cull3' : {'col_name': 'OGC_Cull3', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGC_Zover' : {'col_name': 'OGC_Zover', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGC_TCI_UBVI' : {'col_name': 'OGC_TCI_UBVI', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGC_TCI_BVVI' : {'col_name': 'OGC_TCI_BVVI', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGClowZ' : {'col_name': 'OGClowZ', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'OGCmidZ' : {'col_name': 'OGCmidZ', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_age': {'col_name': 'mm_midZ_oldestmode_age', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_ebv': {'col_name': 'mm_midZ_oldestmode_ebv', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_mass': {'col_name': 'mm_midZ_oldestmode_mass', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_likelihood': {'col_name': 'mm_midZ_oldestmode_likelihood', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_age': {'col_name': 'mm_midZ_bestmode_age', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_ebv': {'col_name': 'mm_midZ_bestmode_ebv', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_mass': {'col_name': 'mm_midZ_bestmode_mass', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_likelihood': {'col_name': 'mm_midZ_bestmode_likelihood', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_age_limlo': {'col_name': 'mm_midZ_oldestmode_age_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_ebv_limlo': {'col_name': 'mm_midZ_oldestmode_ebv_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_mass_limlo': {'col_name': 'mm_midZ_oldestmode_mass_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_age_limlo': {'col_name': 'mm_midZ_bestmode_age_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_ebv_limlo': {'col_name': 'mm_midZ_bestmode_ebv_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_mass_limlo': {'col_name': 'mm_midZ_bestmode_mass_limlo', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_age_limhi': {'col_name': 'mm_midZ_oldestmode_age_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_ebv_limhi': {'col_name': 'mm_midZ_oldestmode_ebv_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_oldestmode_mass_limhi': {'col_name': 'mm_midZ_oldestmode_mass_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_age_limhi': {'col_name': 'mm_midZ_bestmode_age_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_ebv_limhi': {'col_name': 'mm_midZ_bestmode_ebv_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''},
            'mm_midZ_bestmode_mass_limhi': {'col_name': 'mm_midZ_bestmode_mass_limhi', 'unit': None, 'unit_str': '', 'doc_comment': '', 'tab_comment': ''}
        ...
        self.sed_columns_doc = ['PHANGS_AGE_MINCHISQ', 'PHANGS_AGE_MINCHISQ_ERR',
                            ...
                            'NBHa_intensity', 'NBHa_intensity_medsub', 'Clust_HaCDDssSUM_inaper_avg', 'NBHa_mask_medsub_lev1', 'NBHa_mask_medsub_lev2',
                                ...
                                'OGClowZ',
                                'OGCmidZ',
                                'mm_midZ_oldestmode_age',
                                'mm_midZ_oldestmode_ebv',
                                'mm_midZ_oldestmode_mass',
                                'mm_midZ_oldestmode_likelihood',
                                'mm_midZ_bestmode_age',
                                'mm_midZ_bestmode_ebv',
                                'mm_midZ_bestmode_mass',
                                'mm_midZ_bestmode_likelihood',
                                'mm_midZ_oldestmode_age_limlo',
                                'mm_midZ_oldestmode_ebv_limlo',
                                'mm_midZ_oldestmode_mass_limlo',
                                'mm_midZ_bestmode_age_limlo',
                                'mm_midZ_bestmode_ebv_limlo',
                                'mm_midZ_bestmode_mass_limlo',
                                'mm_midZ_oldestmode_age_limhi',
                                'mm_midZ_oldestmode_ebv_limhi',
                                'mm_midZ_oldestmode_mass_limhi',
                                'mm_midZ_bestmode_age_limhi',
                                'mm_midZ_bestmode_ebv_limhi',
                                'mm_midZ_bestmode_mass_limhi']
