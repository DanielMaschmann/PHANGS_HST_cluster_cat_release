...
config_dict = {
    ...
    # flag to raise if a file is not found. This can be handy for early stages in the development as not every target
    # has yet an artifact catalog. For the final version, however, this should be set to True
